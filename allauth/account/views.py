...
class LoginView(RedirectAuthenticatedUserMixin,
    ...
    template_name = app_settings.ACCOUNT_TEMPLATE_DIR + "login.html"
    success_url = None
...
class CloseableSignupMixin(object):
    template_name_signup_closed = app_settings.ACCOUNT_TEMPLATE_DIR + "signup_closed.html"
...
class SignupView(RedirectAuthenticatedUserMixin, CloseableSignupMixin,
    ...
    template_name = app_settings.ACCOUNT_TEMPLATE_DIR + "signup.html"
...
class ConfirmEmailView(TemplateResponseMixin, View):
    ...
    def get_template_names(self):
        if self.request.method == 'POST':
            return [app_settings.ACCOUNT_TEMPLATE_DIR + "email_confirmed.html"]
        else:
            return [app_settings.ACCOUNT_TEMPLATE_DIR + "email_confirm.html"]
...
class EmailView(FormView):
    template_name = app_settings.ACCOUNT_TEMPLATE_DIR + "email.html"
...
class PasswordChangeView(FormView):
    template_name = app_settings.ACCOUNT_TEMPLATE_DIR + "password_change.html"
...
class PasswordSetView(FormView):
    template_name = app_settings.ACCOUNT_TEMPLATE_DIR + "password_set.html"
...
class PasswordResetView(FormView):
    template_name = app_settings.ACCOUNT_TEMPLATE_DIR + "password_reset.html"
...
class PasswordResetDoneView(TemplateView):
    template_name = app_settings.ACCOUNT_TEMPLATE_DIR + "password_reset_done.html"

password_reset_done = PasswordResetDoneView.as_view()


class PasswordResetFromKeyView(FormView):
    template_name = app_settings.ACCOUNT_TEMPLATE_DIR + "password_reset_from_key.html"
...
class PasswordResetFromKeyDoneView(TemplateView):
    template_name = app_settings.ACCOUNT_TEMPLATE_DIR + "password_reset_from_key_done.html"
...
class LogoutView(TemplateResponseMixin, View):
    ...
    template_name = app_settings.ACCOUNT_TEMPLATE_DIR + "logout.html"
    redirect_field_name = "next"
