class AppSettings(object):
    ...
    @property
    def ACCOUNT_TEMPLATE_DIR(self):
        """
        Sets the template directory to use for allauth tempaltes
        """
        from django.conf import settings
        return self._setting("SOCIALACCOUNT_TEMPLATE_DIR",
                             settings.SOCIALACCOUNT_TEMPLATE_DIR)
