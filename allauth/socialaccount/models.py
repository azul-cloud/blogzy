...
def get_social_image_path(instance, filename):
    # the path in which the social button is stored
    return os.path.join('allauth/' + filename)
...
class SocialApp(models.Model):
    ...
    key = models.CharField(verbose_name=_('key'),
                           ...
                           blank=True,
                           help_text=_('Key'))
    image = models.ImageField(upload_to=get_social_image_path, null=True, blank=True)
