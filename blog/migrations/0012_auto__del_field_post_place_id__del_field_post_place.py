...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Post.place_id'
        db.delete_column(u'blog_post', 'place_id')

        # Deleting field 'Post.place'
        db.delete_column(u'blog_post', 'place')


    def backwards(self, orm):
        # Adding field 'Post.place_id'
        db.add_column(u'blog_post', 'place_id',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Post.place'
        db.add_column(u'blog_post', 'place',
