...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BlogSubscription.user'
        db.alter_column(u'blog_blogsubscription', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.User']))

        # Changing field 'Post.author'
        db.alter_column(u'blog_post', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.User']))

        # Changing field 'UserFavorite.user'
        db.alter_column(u'blog_userfavorite', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.User']))

        # Changing field 'UserStreamBlog.user'
        db.alter_column(u'blog_userstreamblog', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.User']))

        # Changing field 'PersonalBlog.owner'
        db.alter_column(u'blog_personalblog', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.User']))

    def backwards(self, orm):

        # Changing field 'BlogSubscription.user'
        db.alter_column(u'blog_blogsubscription', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Post.author'
        db.alter_column(u'blog_post', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'UserFavorite.user'
        db.alter_column(u'blog_userfavorite', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'UserStreamBlog.user'
        db.alter_column(u'blog_userstreamblog', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'PersonalBlog.owner'
        db.alter_column(u'blog_personalblog', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'blog.blogsubscription': {
            'Meta': {'object_name': 'BlogSubscription'},
            'blog': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['blog.PersonalBlog']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sub_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
