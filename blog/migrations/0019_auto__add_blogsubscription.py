...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlogSubscription'
        db.create_table(u'blog_blogsubscription', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('blog', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.PersonalBlog'])),
            ('sub_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'blog', ['BlogSubscription'])


    def backwards(self, orm):
        # Deleting model 'BlogSubscription'
        db.delete_table(u'blog_blogsubscription')
