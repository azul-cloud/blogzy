...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PersonalBlog.owner'
        db.delete_column(u'blog_personalblog', 'owner_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PersonalBlog.owner'
        raise RuntimeError("Cannot reverse this migration. 'PersonalBlog.owner' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PersonalBlog.owner'
        db.add_column(u'blog_personalblog', 'owner',
