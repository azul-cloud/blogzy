...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.image_description'
        db.add_column(u'blog_post', 'image_description',
                      self.gf('django.db.models.fields.CharField')(default='Search Travel Blogs', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.image_description'
        db.delete_column(u'blog_post', 'image_description')
